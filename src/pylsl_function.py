...
info_spt_processing_time = StreamInfo("spt_processing_time", 'task_time', 2, IRREGULAR_RATE, cf_float32, 'spotreport_gui') #unit: seconds
...
info_spt_task_scores = StreamInfo("spt_task_score", 'score', 3, IRREGULAR_RATE, cf_float32, 'spotreport_gui') #unit: seconds
...
spt_task_scores_channels.append_child("channel")\
        .append_child_value("name", "correct")\
        .append_child_value("unit", "number")\
        .append_child_value("type", "int")
spt_task_scores_channels.append_child("channel")\
        .append_child_value("name", "incorrect")\
        .append_child_value("unit", "number")\
        .append_child_value("type", "int")
spt_task_scores_channels.append_child("channel")\
