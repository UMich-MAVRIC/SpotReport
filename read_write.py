...
def input_args():
    ...
    parser.add_argument('width', type=int, required=True, default=1368)
    parser.add_argument('height', type=int, required=True, default=790)
    parser.add_argument('train_images', type=str, required=True, default='training_images/*.png',
                        help="File path for the training images used in the quiz game")
    parser.add_argument('real_images', type=str, required=True, default='real_images/*.png',
                        help="File path for the real images used in the quiz game")
    parser.add_argument('ans_keys', type=str, required=True, default='answer_keys/*.csv', 
                        help="The file where answer keys are written")
    parser.add_argument('output_file_path', type=str, required=True, default='Log_SpotReportScore/', 
                        help="Output file where score is written from the quiz")
    parser.add_argument('output_header_written', type=bool, required=True, default=False, 
                        help="Boolean to control whether the output file header is written or not")
    parser.add_argument('font_type', type=str, required=True, default='Arial MS',
                        help="Default font type used for the entire program")
    parser.add_argument('font_size', type=str, required=True, default='18',
                        help="This is just for default font size, user needs to re-size this for their specific device")
    parser.add_argument('add_pos_x', type=int, required=True, default=1160, 
                        help="x position of Add button on the screen, remains same for all the add buttons")
    parser.add_argument('start_ypos', type=int, required=True, default=90, 
                        help="The starting y position for both Add and Subtract buttons")
    parser.add_argument('sub_pos_x', type=int, required=True, default=850, 
                        help="x position of Subtract button on the screen, remains same for all the subtract buttons")
    parser.add_argument('delta', type=int, required=True, default=120, 
                        help="The difference between the y position of the Add and Subtract buttons on the screen")
    parser.add_argument('label_xpos', type=int, required=True, default=1000, 
                        help="Label positions for all the Buttons")
    parser.add_argument('label_start_ypos', type=int, required=True, default=110, 
                        help="Starting y position for the labels")
    parser.add_argument('img_scale_x', type=int, required=True, default=750, 
                        help="Resizing the image sizes for the game, can be different depending upon user preference")
    parser.add_argument('img_scale_y', type=int, required=True, default=500, 
                        help="Resizing the image sizes for the game, can be different depending upon user preference")
    parser.add_argument('img_pos_x', type=int, required=True, default=40, 
                        help="x position of the image on the game screen")
    parser.add_argument('img_pos_y', type=int, required=True, default=130,
